...
export default function V2() {
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section id="story" className="relative py-12 md:py-16 lg:py-24 pb-24 md:pb-28 lg:pb-36 bg-white overflow-hidden">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg className="relative block w-full h-[60px] md:h-[80px]" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,80 C300,0 900,120 1200,0 L1200,120 L0,120 Z" className="fill-wood-500" />
          </svg>
        </div>
      </section>

      {/* Featured Photos - Text Left, Image Right */}
      <section id="featured" className="relative py-12 md:py-16 lg:py-24 pb-24 md:pb-28 lg:pb-36 bg-wood-500 overflow-hidden">
        <div className="flex items-center justify-center gap-4 mb-10 md:mb-14">
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg className="relative block w-full h-[60px] md:h-[80px]" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0 C300,120 900,0 1200,80 L1200,120 L0,120 Z" fill="white" />
          </svg>
        </div>
      </section>

      {/* Featured Dishes - Card Grid */}
      <section id="dishes" className="relative py-12 md:py-16 lg:py-24 pb-24 md:pb-28 lg:pb-36 bg-white overflow-hidden">
        <div className="flex items-center justify-center gap-4 mb-10 md:mb-14">
          <span className="h-px w-16 md:w-28 bg-gradient-to-r from-transparent to-wood-300/50" />
          ...
          <div className="overflow-x-auto scrollbar-hide -mx-5 px-5 md:mx-0 md:px-0">
            <div className="flex gap-5 md:gap-6 w-max md:w-full md:justify-center">
              {featuredDishes.map((item, i) => (
                <div
                  key={item.name}
                  className={`bg-wood-50 rounded-2xl overflow-hidden shadow-sm hover:shadow-lg transition-all duration-500 ease-out w-[240px] md:w-[280px] flex-shrink-0 ${dishes.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}
                ...
                >
                  ...
                  <div className="p-4 md:p-5">
                    <h3 className="text-base md:text-lg font-bold text-gray-900 mb-1">{item.name}</h3>
                    {item.description && (
                      <p className="text-xs md:text-sm text-gray-500 leading-relaxed line-clamp-2 mb-2">{item.description}</p>
                    )}
                    <span className="text-wood-500 font-bold text-sm md:text-base">{item.price}</span>
                  </div>
                </div>
              ))}
            </div>
      ...
      <section id="contact" className="relative py-12 md:py-16 lg:py-24 pb-24 md:pb-28 lg:pb-36 bg-wood-500 overflow-hidden">
        <div className="flex items-center justify-center gap-4 mb-10 md:mb-14">
          <span className="h-px w-16 md:w-28 bg-gradient-to-r from-transparent to-white/30" />
        ...
        <div ref={contact.ref} className="max-w-6xl mx-auto px-5 md:px-12 lg:px-16">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-20 items-center">
            {/* Image with number */}
            <div
              className={`relative mx-4 md:mx-0 transition-all duration-700 ease-out ${contact.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                }`}
            >
              <div className="absolute -bottom-3 -right-3 md:-bottom-4 md:-right-4 w-full h-full border-2 border-white/30 rounded-2xl" style={{ zIndex: 0 }} />
              <img
            ...
            {/* Text */}
            <div
              className={`transition-all duration-700 delay-150 ease-out ${contact.isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-6'
                }`}
            >
              <p className="text-sm uppercase tracking-[0.25em] text-white/80 mb-3 font-medium text-center lg:text-left">Contact</p>
              <h2 className="text-3xl md:text-4xl lg:text-5xl font-bold mb-6 text-white leading-tight text-center lg:text-left">
                Get In Touch
              </h2>
              <div className="w-16 h-1 bg-white mb-8 rounded-full mx-auto lg:mx-0" />
              ...
              <div className="space-y-6">
                {/* Phone */}
                <a href="tel:09293251868" className="flex items-center gap-4 text-white/80 hover:text-white transition-colors group">
                  <span className="w-12 h-12 flex items-center justify-center rounded-full bg-white/10 group-hover:bg-white/20 transition-colors">
                ...
                {/* Facebook */}
                <a href="https://www.facebook.com/arcasyard/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-white/80 hover:text-white transition-colors group">
                  <span className="w-12 h-12 flex items-center justify-center rounded-full bg-white/10 group-hover:bg-white/20 transition-colors">
                ...
                {/* Instagram */}
                <a href="https://www.instagram.com/arcasyardcafe/" target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 text-white/80 hover:text-white transition-colors group">
                  <span className="w-12 h-12 flex items-center justify-center rounded-full bg-white/10 group-hover:bg-white/20 transition-colors">
                    <svg className="w-5 h-5 text-white" fill="currentColor" viewBox="0 0 24 24">
      ...
      <section id="location" className="relative py-12 md:py-16 lg:py-24 pb-24 md:pb-28 lg:pb-36 bg-white overflow-hidden">
        <div className="flex items-center justify-center gap-4 mb-10 md:mb-14">
          <span className="h-px w-16 md:w-28 bg-gradient-to-r from-transparent to-wood-300/50" />
        ...
        <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none">
          <svg className="relative block w-full h-[60px] md:h-[80px]" viewBox="0 0 1200 120" preserveAspectRatio="none">
            <path d="M0,0 C300,120 900,0 1200,80 L1200,120 L0,120 Z" className="fill-wood-900" />
          </svg>
        </div>
      </section>
